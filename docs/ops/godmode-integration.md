...
Godmode agents are subordinate engineering workers. They must not mutate State Authority, release or production state, obtain or persist secrets, bypass verification, or merge changes. Every write remains in an isolated/reviewable branch and is subject to MediaHub verification and human merge/release authorization.
