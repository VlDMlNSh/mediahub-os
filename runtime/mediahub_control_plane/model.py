...
@dataclass(frozen=True, slots=True)
class Task:
    task_id: str; type: str; payload: Any=None; priority: int=0; status: TaskStatus=TaskStatus.PENDING; dependencies: tuple[str,...]=(); idempotency_key: str|None=None; attempt: int=0; max_attempts: int=1
@dataclass(frozen=True, slots=True)
class Lease:
