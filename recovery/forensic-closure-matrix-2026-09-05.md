...
A full owner-to-boundary comparison exposed two additional canonical owners present in the capability registry but absent from the implementation-map component list: `product_core` (CAP-053) and `runtime_core` (CAP-035). This was a structural implementation-boundary gap, not functional loss. Both boundaries were added.
...
5. No canonical capability was deleted, renamed into oblivion, merged away, or downgraded as a result of this pass.
